              ...
              <Card className="bg-gray-50">
                <CardContent className="p-3">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-600">{selectedCustomer.mobile}</p>
                    <div className="flex items-center justify-center mt-1 space-x-2">
                      {selectedCustomer.membership && (
                        <Badge variant="secondary" className="text-xs">
                          {selectedCustomer.membership.membershipPlan.name}
                        </Badge>
                      )}
                ...
                {selectedCustomer && selectedCustomer.loyaltyPoints > 0 && (
                  <div className="mb-6 p-4 bg-white rounded-xl border-2 border-orange-200">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      Available: {selectedCustomer.loyaltyPoints} points (Max: Rs. {Math.min(selectedCustomer.loyaltyPoints, getSubtotal()).toLocaleString()})
                    </p>
                  </div>
                )}
